...
- 🧠 **[memorix-sdk](https://github.com/pramodtoraskar/memorix-sdk)** — Core SDK: modular API, YAML config, tiered agentic memory
- 🌐 **[memorix-server](https://github.com/pramodtoraskar/memorix-server)** — REST API server exposing MemoryAPI for AI agents
- 🔌 **[memorix-embedders](https://github.com/pramodtoraskar/memorix-embedders)** — Embedding plugins: OpenAI, Gemini, HuggingFace
...
→ **Building Memorix AI** — agentic memory SDK for AI systems with recall, context, and privacy  
→ **Patent drafting** — around agentic memory systems and AI platform design  
→ **Open-source** — tools that bridge data platforms and agentic AI workflows  
→ **Writing** — sharing learnings on LLM inference, memory, and agent orchestration  

---

> "Build tools that solve real problems. Ship them publicly. Let the work speak."

---

## 🤝 Connect

[![LinkedIn](https://img.shields.io/badge/LinkedIn-pramodtoraskar-blue?style=flat-square&logo=linkedin)](https://linkedin.com/in/pramodtoraskar)
[![Email](https://img.shields.io/badge/Email-pramodtoraskar5%40gmail.com-red?style=flat-square&logo=gmail)](mailto:pramodtoraskar5@gmail.com)
